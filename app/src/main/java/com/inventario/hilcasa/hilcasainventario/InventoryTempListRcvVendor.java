...
public class InventoryTempListRcvVendor {

    private String sBarcode, sComponentDesc, sQuantity, sComponentId, sEmployeeId;

    public InventoryTempListRcvVendor() {}

    public InventoryTempListRcvVendor(String sBarcode, String sComponentDesc, String sQuantity, String sComponentId,String sEmployeeId) {
