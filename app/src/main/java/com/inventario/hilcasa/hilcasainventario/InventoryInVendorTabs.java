...
public class InventoryInVendorTabs extends Fragment implements PublicInterface{
    ...
    FloatingActionButton fabClearLog, fabAdd;
    ...
    class SamplePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if(position == 1){
                view = getActivity().getLayoutInflater().inflate(R.layout.frmtabinventoryinvendor,
                        container, false);
                ...
                view = getActivity().getLayoutInflater().inflate(R.layout.frmtabinventoryinvendorcreate,
                        container, false);
                HideKeyboard(view);
                ...
                fabClearLog.setOnClickListener(new View.OnClickListener() {
                 ...
                 view = getActivity().getLayoutInflater().inflate(R.layout.frmtabinventoryinvendorlog,
                        container, false);
                HideKeyboard(view);
    ...
    public void ShowTempList(){
        ...
        if(cCursor.moveToFirst()){
            ...
            do{
                ilLog = new InventoryTempListRcvVendor(cCursor.getString(4) ,cCursor.getString(1) , cCursor.getString(2),cCursor.getString(0), sUser);
                TempList.add(ilLog);
        ...
        try {
            ...
            txtBarcode.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                    ...
                    }else{cCursor = dbQrs.GetComponentsByBarcode(txtBarcode.getText().toString(),sProductStateFrom);
                        if(cCursor.moveToFirst()){
           ...
           /* cCursor = dbQrs.GetAllComponents();
            if(cCursor.moveToFirst()){
                do {
                    hmList.put(cCursor.getString(2), cCursor.getString(3));
                    lList.add(cCursor.getString(2));
                    ...
                    if (/*txtBarcode.getText().toString().length() < 1 ||*/ txtQuantity.getText().toString().length() < 1) {
                        ...
                        if (cCursor.moveToFirst()) {
                            ...
                            if (cCursor.moveToFirst()) {
                                ...
                                dbQrs.InsertTempList(sComponentId,  sComponentDesc, sTempQuantity, sUser, txtBarcode.getText().toString() );
                                ShowTempList();
    ...
    private class SetData extends AsyncTask<Void, Void, SetData> {
        String sError = "";
        @Override
        protected InventoryInVendorTabs.SetData doInBackground(Void... params) {
            try {
                    ...
                    if(sNewContainerId.length()>0){
                        ...
                        if (sMasterQuery.contains(String.valueOf((char) 167))) {
                            ...
                            for (int n1 = 0; n1 < sDataM.length; n1++) {
                                ...
                                String sAreaId= sDataRow[5];
                                String sBinId = sDataRow[6];
        ...
        @Override
        protected void onPostExecute(InventoryInVendorTabs.SetData SetData) {
            if (pgProgressDialog != null) {
                pgProgressDialog.dismiss();
            }
            ShowLog(sAreaId);
