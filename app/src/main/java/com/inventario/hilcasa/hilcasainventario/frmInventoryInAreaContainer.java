 ...
 */
public class frmInventoryInAreaContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frminventoryinareacontainer);
       ...
       getCurrentUser();
        ...
        getSupportActionBar().setTitle(R.string.sRecepcionArea);
        if (savedInstanceState == null) {
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            InventoryInAreaTabs fragment = new InventoryInAreaTabs();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            ...
            case R.id.btnLastLog:
                ...
                bdlExtras.putString("sIdentifier",cfData.sIdentifierAreaIn);
