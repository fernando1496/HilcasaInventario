 ...
 */
public class frmInventoryInVendorContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frminventoryinvendorcontainer);
       ...
       getCurrentUser();
        ...
        getSupportActionBar().setTitle(R.string.sRecepcionProveedor);
        if (savedInstanceState == null) {
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            InventoryInVendorTabs fragment = new InventoryInVendorTabs();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            ...
            case R.id.btnLastLog:
                ...
                bdlExtras.putString("sIdentifier",cfData.sIdentifierVendorIn);
