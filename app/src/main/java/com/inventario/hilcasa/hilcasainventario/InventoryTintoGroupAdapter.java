...
public class InventoryTintoGroupAdapter extends RecyclerView.Adapter<InventoryTintoGroupAdapter.MyViewHolder> {

    private List<InventorTintoGroup> LogList;
            ...
            btnDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(isConnectedToNetwork()) {
                        ...
                        InventorTintoGroup Log = LogList.get(getAdapterPosition());
    ...
    public InventoryTintoGroupAdapter(List<InventorTintoGroup> LogList, PublicInterface piInterace) {
    ...
    public void onBindViewHolder(MyViewHolder holder,final int position) {
        ...
        InventorTintoGroup Log = LogList.get(position);
    ...
    private class DeleteContainer extends AsyncTask<Void, Void, DeleteContainer> {
        ...
        protected DeleteContainer doInBackground(Void... params) {
            try {
                InventorTintoGroup Log = LogList.get(iCurrentPosition);
                RestTemplate restTemplate = new RestTemplate();
                restTemplate.getMessageConverters().add(new MappingJackson2HttpMessageConverter());

                GetDataWS GetData = restTemplate.getForObject(cfData.sUrlDeleteTempGroupedContainersTinto(Log.getsBarcode(), sEmployeeId, sScannerId), GetDataWS.class);
