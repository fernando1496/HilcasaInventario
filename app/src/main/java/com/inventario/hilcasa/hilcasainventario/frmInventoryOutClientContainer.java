 ...
 */
public class frmInventoryOutClientContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.sDespacho);
        if (savedInstanceState == null) {
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            InventoryOutClientTabs fragment = new InventoryOutClientTabs();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case R.id.btnLastLog:
                ...
                bdlExtras.putString("sIdentifier",cfData.sIdentifierCustomerOut);
