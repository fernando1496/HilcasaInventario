 ...
 */
public class frmInventoryRelocationContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frminventoryrelocationcontainer);
       ...
       getCurrentUser();
        ...
        getSupportActionBar().setTitle(R.string.sReubicacion);
        if (savedInstanceState == null) {
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            InventoryAreaRelocation fragment = new InventoryAreaRelocation();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            ...
            case R.id.btnLastLog:
                ...
                bdlExtras.putString("sIdentifier",cfData.sIdentifierRelocation);
