 ...
 */
public class frmInventoryCheck extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frminventorycheck);
        ...
        getSupportActionBar().setTitle(R.string.sTomaInv);
        if (savedInstanceState == null) {
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            InventoryCheckTabs fragment = new InventoryCheckTabs();
        ...
        switch(item.getItemId()) {
            case R.id.btnSinc:
                if (isConnectedToNetwork()) {
                    pgProgressDialog = new ProgressDialog(frmInventoryCheck.this);
            ...
            case R.id.btnLastLog:
                ...
                bdlExtras.putString("sIdentifier",cfData.sIdentifierCheck);
    ...
    private void EditWeight(final String sContainerNumber,final String sContainerWeight) {
        try {
            ...
            LayoutInflater liLayoutInflater = LayoutInflater.from(frmInventoryCheck.this);
            View vPromptsView = liLayoutInflater.inflate(R.layout.editweightmodal, null);
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(frmInventoryCheck.this);
    ...
    private class GetData extends AsyncTask<Void, Void, frmInventoryCheck.GetData> {
        String sError = "";
        @Override
        protected frmInventoryCheck.GetData doInBackground(Void... params) {
            try {
        ...
        @Override
        protected void onPostExecute(frmInventoryCheck.GetData GetData) {
