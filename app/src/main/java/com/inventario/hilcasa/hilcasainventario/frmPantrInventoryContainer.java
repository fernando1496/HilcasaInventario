 ...
 */
public class frmPantrInventoryContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frminventorypantrcontainer);
       ...
       getCurrentUser();
        ...
        getSupportActionBar().setTitle("Toma inventario despensa");
        if (savedInstanceState == null) {
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            InventoryPantrTabs fragment = new InventoryPantrTabs();
